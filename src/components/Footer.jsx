            ...
            <Container>
                    ...
                    <div
                        ...
                        <div className="ml-8 lg:w-64">
                            <p className="text-base font-semibold text-gray-900">
                                <Link href="https://apps.apple.com/us/app/big-up/id6446843866">
                ...
                <div
                    ...
                    <p className="mt-6 text-sm text-gray-500 md:mt-0">
                        ...
                        <a href={'https://app.getterms.io/view/b4qwj/privacy/en-us'} className={'mx-1 underline'} target={'blank'}>Privacy Policy.</a>
                        <a href={'https://app.getterms.io/view/b4qwj/tos/en-us'} className={'mx-1 underline'} target={'blank'}>Terms of Use.</a>
                    </p>
                </div>
            </Container>
        </footer>
